...
If you are new, this guide is written for you in plain language.
...
The system is designed so contributions are reviewed, improved, and preserved responsibly.
...
This protects trust and community responsibility.
...
- `APPROVED_UNDER_REVIEW` = public but flagged for re-review
- `REJECTED` = needs correction before public return
- `ARCHIVED` = inactive
...
- source/media-source conditions are applied honestly
- uploaded media matches the entry
...
Important principle:
Historical contribution credit is preserved as an achievement record.
...
3. Add useful examples, not generic ones.
4. Include pronunciation/audio where possible.
5. Use reviewer notes as a learning tool.
...
- respect local context and meanings
- use language that preserves dignity

Cultural quality is more important than quantity.
...
4. Revision-based quality stewardship
5. Mentoring new contributors informally

Your best metric is not just number of entries.
Your best metric is **lasting usefulness + cultural integrity**.
...
One approved term can teach someone.
One preserved story can reconnect a family.
One clean revision can improve learning for years.

Your contribution is part of continuity.

Contribute with care.
Contribute with pride.
Contribute so memory stays alive.
