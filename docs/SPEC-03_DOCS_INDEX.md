...
1. `docs/SPEC-03_DEVELOPER_HANDOFF_SPEC.md`
- Full implementation contract (backend + integration behavior).

2. `docs/SPEC-03_GAMIFICATION_FEATURE_SPEC_DRAFT.md`
- Gamification v2.2 rules and editable policy draft.

3. `docs/SPEC-03_MANUAL_QA_CHECKLIST.md`
- End-to-end manual QA procedure.

4. `docs/SPEC-03_QA_WORKSHEET_EDITABLE.md`
- Beginner-friendly QA checklist with editable pass/fail notes.

5. `docs/SPEC-03_FRONTEND_FIGMA_HANDOFF.md`
- Detailed beginner Figma build instructions for final UI.

6. `docs/SPEC-03_PLAIN_ENGLISH_PAGE_MAP.md`
- Role-by-role page map (visitor, contributor, reviewer).

7. `docs/SPEC-03_GAMIFICATION_IMPLEMENTATION_NOTES.md`
- What is already implemented in backend gamification.

8. `docs/SPEC-03_DEFENSE_ARCHITECTURE_PACK.md`
- Defense-ready diagrams: ERD, state machines, and sequence flows.

9. `docs/PUBLIC_DEPLOYMENT_TEMPLATE.md`
- Exact local/staging/production deployment settings and release gate.

10. `docs/PUBLIC_DEPLOYMENT_TEMPLATE.md`
...
1. `SPEC-03_DEVELOPER_HANDOFF_SPEC.md`
2. `SPEC-03_GAMIFICATION_FEATURE_SPEC_DRAFT.md`
3. `SPEC-03_MANUAL_QA_CHECKLIST.md`
